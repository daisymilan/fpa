        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-12">
          ...
          <div className="lg:col-span-1">
            ...
            <div className="flex gap-4 mt-6">
              <a
                ...
                aria-label="Facebook"
                className="w-9 h-9 flex items-center justify-center hover:text-[#FF3B30] hover:border-[#FF3B30] transition-colors duration-200"
              ...
              >
                <svg className="w-4 h-4 fill-current" viewBox="0 0 24 24">
                  <path d="M12 0C5.373 0 0 4.974 0 11.111c0 3.498 1.744 6.614 4.479 8.652V24l4.086-2.242c1.09.301 2.246.464 3.435.464 6.627 0 12-4.974 12-11.111C24 4.974 18.627 0 12 0zm1.191 14.963l-3.055-3.26-5.963 3.26L10.732 8l3.131 3.26L19.752 8l-6.561 6.963z" />
                </svg>
              </a>
            </div>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-3">
              {quickLinks.map((link) => (
                <li key={link.href}>
                  <Link href={link.href} className="text-fg-dim text-sm hover:text-[#FF3B30] transition-colors duration-200">
                    {link.label}
                  </Link>
                </li>
              ))}
          ...
          <div>
            ...
            <ul className="space-y-4">
              <li className="flex gap-3">
                <svg className="w-4 h-4 text-[#FF3B30] flex-shrink-0 mt-0.5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M17.657 16.657L13.414 20.9a1.998 1.998 0 01-2.827 0l-4.244-4.243a8 8 0 1111.314 0z" />
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M15 11a3 3 0 11-6 0 3 3 0 016 0z" />
                </svg>
                <span className="text-fg-dim text-sm">Baguio City, Benguet, Philippines</span>
              </li>
              <li className="flex gap-3">
                <svg className="w-4 h-4 text-[#FF3B30] flex-shrink-0 mt-0.5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M3 5a2 2 0 012-2h3.28a1 1 0 01.948.684l1.498 4.493a1 1 0 01-.502 1.21l-2.257 1.13a11.042 11.042 0 005.516 5.516l1.13-2.257a1 1 0 011.21-.502l4.493 1.498a1 1 0 01.684.949V19a2 2 0 01-2 2h-1C9.716 21 3 14.284 3 6V5z" />
                </svg>
                <div className="text-fg-dim text-sm space-y-1">
                  <a href="tel:+63744244644" className="block hover:text-[#FF3B30] transition-colors">(074) 424 4644</a>
                  <a href="tel:+639454221874" className="block hover:text-[#FF3B30] transition-colors">0945 422 1874</a>
                </div>
              </li>
              <li className="flex gap-3">
                <svg className="w-4 h-4 text-[#FF3B30] flex-shrink-0 mt-0.5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <a href="mailto:fpadesignconsultancy@gmail.com" className="text-fg-dim text-sm hover:text-[#FF3B30] transition-colors duration-200 break-all">
