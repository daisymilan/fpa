        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-5 gap-16">
            ...
            <div className="lg:col-span-2">
              ...
              <h2 className="display-heading text-white mb-8 leading-tight" style={{ fontSize: "clamp(1.5rem, 2.5vw, 2rem)" }}>
                Reach Us Directly
              </h2>

              <div className="space-y-6">
                <div className="flex gap-4">
                  <div className="w-10 h-10 bg-[#c41230]/10 border border-[#c41230]/20 flex items-center justify-center flex-shrink-0">
                    <svg className="w-4 h-4 text-[#c41230]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M17.657 16.657L13.414 20.9a1.998 1.998 0 01-2.827 0l-4.244-4.243a8 8 0 1111.314 0z" />
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M15 11a3 3 0 11-6 0 3 3 0 016 0z" />
                    </svg>
                  </div>
                  <div>
                    <p className="text-xs text-stone-600 tracking-widest uppercase mb-1">Office Location</p>
                    <p className="text-stone-400 text-sm leading-relaxed">
                      Baguio City, Benguet<br />Philippines
                    </p>
                  </div>
                </div>
                ...
                <div className="flex gap-4">
                  ...
                  <div>
                    ...
                    <div className="space-y-1">
                      <a href="tel:+63744244644" className="block text-stone-400 text-sm hover:text-white transition-colors">(074) 424 4644</a>
                      <a href="tel:+639454221874" className="block text-stone-400 text-sm hover:text-white transition-colors">0945 422 1874</a>
                    </div>
                  </div>
                </div>
                ...
                <div className="flex gap-4">
                  ...
                  <div>
                    ...
                    <a href="mailto:fpadesignconsultancy@gmail.com" className="text-stone-400 text-sm hover:text-white transition-colors break-all">
                ...
                <div className="flex gap-4">
                  ...
                  <div>
                    <p className="text-xs text-stone-600 tracking-widest uppercase mb-1">Facebook</p>
                    <a href="https://www.facebook.com/share/1E4rr19U8p/?mibextid=wwXIfr" target="_blank" rel="noopener noreferrer" className="text-stone-400 text-sm hover:text-white transition-colors">
                ...
                <div className="flex gap-4">
                  ...
                  <div>
                    <p className="text-xs text-stone-600 tracking-widest uppercase mb-1">Instagram</p>
                    <a href="https://www.instagram.com/fpadesignconsultancy?igsh=MWcxZDBibXh0aDRoMA==" target="_blank" rel="noopener noreferrer" className="text-stone-400 text-sm hover:text-white transition-colors">
