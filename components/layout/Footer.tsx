        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-12">
          ...
          <div className="lg:col-span-1">
            ...
            <div className="flex gap-4 mt-6">
              <a
                ...
                aria-label="Facebook"
                className="w-9 h-9 flex items-center justify-center hover:text-[#c41230] hover:border-[#c41230] transition-colors duration-200"
          ...
          <div>
            ...
            <ul className="space-y-3">
              {quickLinks.map((link) => (
                <li key={link.href}>
                  <Link href={link.href} className="text-fg-dim text-sm hover:text-[#c41230] transition-colors duration-200">
                    {link.label}
                  </Link>
                </li>
              ))}
          ...
          <div>
            ...
            <ul className="space-y-4">
              <li className="flex gap-3">
                <svg className="w-4 h-4 text-[#c41230] flex-shrink-0 mt-0.5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              <li className="flex gap-3">
                ...
                <div className="text-fg-dim text-sm space-y-1">
                  <a href="tel:+63744244644" className="block hover:text-[#c41230] transition-colors">(074) 424 4644</a>
                  <a href="tel:+639454221874" className="block hover:text-[#c41230] transition-colors">0945 422 1874</a>
                </div>
              </li>
              <li className="flex gap-3">
                <svg className="w-4 h-4 text-[#c41230] flex-shrink-0 mt-0.5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <a href="mailto:fpadesignconsultancy@gmail.com" className="text-fg-dim text-sm hover:text-[#c41230] transition-colors duration-200 break-all">
