          ...
          <div className="grid grid-cols-1 lg:grid-cols-5 gap-16">
            ...
            <div className="lg:col-span-2">
              <div className="flex items-center gap-3 mb-6">
                <div className="w-8 h-px bg-[#c41230]" />
                <span className="text-[#c41230] text-xs font-semibold tracking-[0.3em] uppercase">{tx.infoTag}</span>
              </div>
            ...
            <div className="lg:col-span-3">
              <div className="flex items-center gap-3 mb-6">
                <div className="w-8 h-px bg-[#c41230]" />
                <span className="text-[#c41230] text-xs font-semibold tracking-[0.3em] uppercase">{tx.formTag}</span>
              </div>
              <h2 className="display-heading text-fg mb-8 leading-tight" style={{ fontSize: "clamp(1.5rem, 2.5vw, 2rem)" }}>
                {tx.formHeading}
              </h2>
